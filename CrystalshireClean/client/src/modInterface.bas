...
Public Sub CreateWindow_Login()
    ' Create the window
    CreateWindow "winLogin", "Login", zOrder_Win, 0, 0, 276, 212, Tex_Item(1), , Fonts.rockwellDec_15, , 3, 5, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
...
Public Sub CreateWindow_Register()
    ...
    ' Create the window
    CreateWindow "winRegister", "Register", zOrder_Win, 0, 0, 276, 302, Tex_Item(2), , Fonts.rockwellDec_15, , 3, 5, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Characters()
    ' Create the window
    CreateWindow "winCharacters", "Characters", zOrder_Win, 0, 0, 364, 229, Tex_Item(2), False, Fonts.rockwellDec_15, , 3, 5, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Loading()
    ' Create the window
    CreateWindow "winLoading", "Loading", zOrder_Win, 0, 0, 278, 79, Tex_Item(3), True, Fonts.rockwellDec_15, , 2, 7, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Dialogue()
    ...
    CreateWindow "winDialogue", "Warning", zOrder_Win, 0, 0, 348, 145, Tex_Item(4), , Fonts.rockwellDec_15, , 3, 5, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, , , , , , , , , , False
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Classes()
    ' Create window
    CreateWindow "winClasses", "Select Class", zOrder_Win, 0, 0, 364, 229, Tex_Item(5), False, Fonts.rockwellDec_15, , 2, 6, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_NewChar()
    ' Create window
    CreateWindow "winNewChar", "Create Character", zOrder_Win, 0, 0, 291, 172, Tex_Item(1), False, Fonts.rockwellDec_15, , 2, 6, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Menu()
    ...
    ' Buttons
    CreateButton WindowCount, "btnChar", 8, 1, 29, 29, , , , Tex_Item(3), , , , , , DesignTypes.desGreen, DesignTypes.desGreen_Hover, DesignTypes.desGreen_Click, , , GetAddress(AddressOf btnMenu_Char), , , -1, -2, , , "Character (C)"
    ...
    CreateButton WindowCount, "btnSkills", 82, 1, 29, 29, , , , Tex_Item(4), , , , , , DesignTypes.desGreen, DesignTypes.desGreen_Hover, DesignTypes.desGreen_Click, , , GetAddress(AddressOf btnMenu_Skills), , , -1, -2, , , "Skills (M)"
    ...
    CreateButton WindowCount, "btnMap", 119, 1, 29, 29, , , , Tex_Item(5), , , , , , DesignTypes.desGrey, DesignTypes.desGrey, DesignTypes.desGrey, , , GetAddress(AddressOf btnMenu_Map), , , -1, -2
    CreateButton WindowCount, "btnGuild", 155, 1, 29, 29, , , , Tex_Item(1), , , , , , DesignTypes.desGrey, DesignTypes.desGrey, DesignTypes.desGrey, , , GetAddress(AddressOf btnMenu_Guild), , , -1, -1
    CreateButton WindowCount, "btnQuest", 191, 1, 29, 29, , , , Tex_Item(2), , , , , , DesignTypes.desGrey, DesignTypes.desGrey, DesignTypes.desGrey, , , GetAddress(AddressOf btnMenu_Quest), , , -1, -2
End Sub
...
Public Sub CreateWindow_Character()
    ' Create window
    CreateWindow "winCharacter", "Character Status", zOrder_Win, 0, 0, 174, 356, Tex_Item(3), False, Fonts.rockwellDec_15, , 2, 6, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, , , , , GetAddress(AddressOf Character_MouseMove), GetAddress(AddressOf Character_MouseDown), GetAddress(AddressOf Character_MouseMove), GetAddress(AddressOf Character_MouseMove), , , GetAddress(AddressOf DrawCharacter)
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Shop()
    ' Create window
    CreateWindow "winShop", "Shop", zOrder_Win, 0, 0, 278, 293, Tex_Item(1), False, Fonts.rockwellDec_15, , 2, 5, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, , , , , GetAddress(AddressOf Shop_MouseMove), GetAddress(AddressOf Shop_MouseDown), GetAddress(AddressOf Shop_MouseMove), GetAddress(AddressOf Shop_MouseMove), , , GetAddress(AddressOf DrawShopBackground)
...
Public Sub CreateWindow_NpcChat()
    ' Create window
    CreateWindow "winNpcChat", "Conversation with [Name]", zOrder_Win, 0, 0, 480, 228, Tex_Item(3), False, Fonts.rockwellDec_15, , 2, 11, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Trade()
    ' Create window
    CreateWindow "winTrade", "Trading with [Name]", zOrder_Win, 0, 0, 412, 386, Tex_Item(2), False, Fonts.rockwellDec_15, , 2, 5, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, DesignTypes.desWin_Empty, , , , , , , , , , , GetAddress(AddressOf DrawTrade)
    ' Centralise it
    CentraliseWindow WindowCount
...
Public Sub CreateWindow_Guild()
    ' Create window
    CreateWindow "winGuild", "Guild", zOrder_Win, 0, 0, 174, 320, Tex_Item(5), False, Fonts.rockwellDec_15, , 2, 6, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm, DesignTypes.desWin_Norm
    ' Centralise it
    CentraliseWindow WindowCount
